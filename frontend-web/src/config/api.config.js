...
export const API_ENDPOINTS = {
  ...
  HR: {
    ...
    // Chấm công (Backend uses /api/cham-cong prefix)
    ...
    PAYROLL_BY_EMPLOYEE_PERIOD: (empId) => `/bang-luong/nhan-vien/${empId}/period`,
    PAYROLL_BY_PERIOD: '/bang-luong/period',
    PAYROLL_PAGE: '/bang-luong/page',
    PAYROLL_CALCULATE_AUTO: (empId) => `/bang-luong/tinh-tu-dong/${empId}`,
    PAYROLL_CALCULATE_AUTO_ALL: '/bang-luong/tinh-tu-dong-tat-ca',
    PAYROLL_MARK_PAID: (id) => `/bang-luong/${id}/mark-paid`,
    PAYROLL_CANCEL: (id) => `/bang-luong/${id}/cancel`,
    PAYROLL_TOTAL_PERIOD: '/bang-luong/total/period',
  },
