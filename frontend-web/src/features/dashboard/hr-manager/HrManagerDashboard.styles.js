// Styles for HR Manager Dashboard - Soft UI Design with Dark Gray Theme
export const styles = {
  appShell: {
    display: 'grid',
  ...
  orderIcon: (status) => ({
    ...
    height: 32,
    borderRadius: 8,
    background: status === 'approved' ? '#e5e7eb' : status === 'pending' ? '#fef3c7' : '#fee2e2',
    color: status === 'approved' ? '#374151' : status === 'pending' ? '#d97706' : '#dc2626',
    display: 'grid',
    placeItems: 'center',
    fontSize: 16,
    fontWeight: 700
  ...
  chatContactItemActive: {
    background: 'linear-gradient(90deg, rgba(55, 65, 81, 0.1) 0%, rgba(75, 85, 99, 0.05) 100%)',
  ...
  chatUnreadBadge: {
    ...
    placeItems: 'center',
    flexShrink: 0,
    boxShadow: '2px 2px 6px rgba(245, 158, 11, 0.4)'
  },
