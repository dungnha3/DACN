...
import { NavItem, RoleBadge, KPICard, StatusBadge, EmployeeStatusBar, DepartmentCard, QuickActionBtn } from './components/AdminDashboard.components'
import { adminKpiData, employeeData, departmentData, leaveRequestsAdmin, attendanceOverview, adminNotifications, payrollOverview, recentActivities, adminSectionsConfig } from './components/AdminDashboard.constants'

export default function AdminDashboard() {
  console.log('AdminDashboard rendering'); // Debug
  ...
  console.log('AdminDashboard - sections:', sections); // Debug
  console.log('AdminDashboard - meta:', meta); // Debug
