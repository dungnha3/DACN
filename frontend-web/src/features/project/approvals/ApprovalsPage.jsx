  ...
  return (
    <PageContainer>
      ...
      <div style={{ marginBottom: 32, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <Breadcrumb style={{ fontSize: 13, color: '#64748b', marginBottom: 4 }}>Quản lý dự án / Duyệt nghỉ phép</Breadcrumb>
          <PageTitle style={{ color: '#0f172a', fontSize: 24 }}>Duyệt Đơn Nghỉ Phép</PageTitle>
        </div>
      </div>
